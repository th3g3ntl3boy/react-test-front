                ...
                <Row className="align-items-center">
                    <Col md={{ span: 6, offset: 3 }}>
                        <div className="text-center">
                            <h1>Prediciction</h1>
                            <p><i>"how to predict something with model"</i></p>
                        </div>
                    </Col>
                    <Col md={3}>
                        <Link to="/algorithm/forecasting" style={{ textDecoration: 'none', color: 'black',textAlign: 'left' }}>
                            <Arrow halaman="Forecasting">
                            </Arrow>
                        </Link>
                    </Col>
                </Row>
