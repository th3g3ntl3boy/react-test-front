                ...
                <Row className="align-items-center">
                    <Col md={{ span: 6, offset: 3 }}>
                        <div className="text-center">
                            <h1>Clustering</h1>
                            <p><i>"separate groups based on their proximity"</i></p>
                        </div>
                    </Col>
                    <Col md={3}>
                        <Link to="/algorithm/prediction" style={{ textDecoration: 'none', color: 'black',textAlign: 'left' }}>
                            <Arrow halaman="Prediction">
                            </Arrow>
                        </Link>
                    </Col>
                </Row>
