                ...
                <Row className="align-items-center">
                    <Col md={{ span: 6, offset: 3 }}>
                        <div className="text-center">
                            <h1>Descriptive</h1>
                            <p><i>"what just happen with our data"</i></p>
                        </div>
                    </Col>
                    <Col md={3}>
                        <Link to="/algorithm/classification" style={{ textDecoration: 'none', color: 'black',textAlign: 'left' }}>
                            <Arrow halaman="Classification">
                            </Arrow>
                        </Link>
                    </Col>
                </Row>
